        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="mt-1.5">
              <span className="font-medium text-foreground">{feature}</span> is a Plus feature.
              Upgrade to unlock story extend to 48h, 6 pinned posts, super hearts, hide-from-feed
              posts, and more.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="gap-3 mt-6">
            <Button variant="outline" onClick={() => setFeature(null)}>
              Not now
            </Button>
            <Button onClick={upgrade}>
              <Sparkles className="h-4 w-4" />
              Upgrade for free (demo)
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
