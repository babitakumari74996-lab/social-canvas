      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-3 space-y-2">
        {messages?.map((m) => {
          ...
          return (
            <div
              key={m.id}
              className={`flex ${mine ? "justify-end" : "justify-start"} animate-in-fade`}
            >
              <div
              ...
              >
                ...
                {m.is_disappearing && (
                  <span
                    className={`ml-2 inline-flex items-center gap-0.5 text-[10px] ${mine ? "opacity-80" : "text-muted-foreground"}`}
                  >
